...
namespace IndexerLib
{
    public class IndexerHtml : Indexer
    {
        ...
        {
            return string.Format("Generated by {0} on {1}.", string.Format("<a href=\"{0}\">{1}</a>", Links.URL_WEBSITE, string.Format("{0} v{1}", Application.ProductName, Application.ProductVersion)),
