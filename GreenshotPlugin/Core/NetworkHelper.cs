...
namespace GreenshotPlugin.Core
{
    ...
    public class ByteContainer : IBinaryContainer
    {
        ...
        public ByteContainer(byte[] file)
            : this(file, null)
        {
        }

        public ByteContainer(byte[] file, string filename)
            : this(file, filename, null)
        {
        }

        public ByteContainer(byte[] file, string filename, string contenttype)
            : this(file, filename, contenttype, 0)
        {
        }
